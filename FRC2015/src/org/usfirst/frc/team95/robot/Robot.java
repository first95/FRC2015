...
public class Robot extends IterativeRobot {
	...
	public Encoder frontLeftEncoder, frontRightEncoder, backLeftEncoder,
			backRightEncoder, armEncoder, fingerEncoder;
	...
	ButtonTracker changeDriveStyle, rotate90Left, rotate90Right, autoStack,
			autoStackBoth, autoStackCan, autoGrabCan, autoTakeTote,
	...
	public void robotInit() {
		...
		armEncoder = new Encoder(RobotConstants.kArmEncoder,
		...
		armController = new PIDController(RobotConstants.kArmP,
				RobotConstants.kArmI, RobotConstants.kArmD, armEncoder,
				armMotors, RobotConstants.kPIDUpdateInterval);
		armController.setAbsoluteTolerance(RobotConstants.kArmTolerance);
		armController.disable();

		autoArmController = new PIDController(RobotConstants.kArmDistanceP,
	...
	public void teleopPeriodic() {
		 ...
		 * armController.setSetpoint(RobotConstants.kArmPositionBehind); } else
		 * if (armEncoder.getDistance() < RobotConstants.kArmPositionGrab) {
		 * armController.setSetpoint(RobotConstants.kArmPositionGrab); } else {
