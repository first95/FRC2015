...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		armController = new PIDController(RobotConstants.kArmP,
				...
				armTalon, RobotConstants.kPIDUpdateInterval);
