...
public class RobotConstants {
	...
	public static int kChangeDriveStyle = 11;
	public static int kFieldCentric = 2;
	public static int kRotate90Left = 3;
	public static int kRotate90Right = 4;
	public static int kAutoStack = 8;
	public static int kAutoStackCan1 = 5;
	public static int kAutoStackCan2 = 6;
	public static int kAutoStackCan3 = 7;
	public static int kAutoGrabCan = 9;
	public static int kAutoStackCan = 8;
	public static int kAutoStackBoth = 6;
	...
	public static double kRotationTolerance = 5;
	public static double kMaxRotationSpeed = 1800 / Math.PI; // degrees / sec
	public static int kLeftArmMotorCurrent = 15;
