...
public class TakeBarrierTotes extends PureSequentialMove {
	...
	public TakeBarrierTotes(Robot robot) {
		AutoMove[] moves = { new MoveFauxPIDTo(robot.fingerController, RobotConstants.kFingerSetpoints[0]),
				new GoForward(robot, 0.75, 0.5),
				new MoveFauxPIDTo(robot.fingerController, RobotConstants.kFingerSetpoints[2]),
